namespace AngleSharp.Io
{
    ...
    /// </summary>
    public class MyDefaultHttpRequester : BaseRequester
    {
        #region Constants
        ...
        public MyDefaultHttpRequester(String userAgent = null, Action<HttpWebRequest> setup = null)
        {
        ...
        private sealed class RequestState
        {
            ...
            private DefaultResponse GetResponse(HttpWebResponse response)
            {
                if (response != null)
                {
                    ...
                    var cookies = newCookies.OfType<System.Net.Cookie>().Except(originalCookies.OfType<System.Net.Cookie>()).ToArray();
            ...
            /// </summary>
            private static String Stringify(System.Net.Cookie cookie)
            {
                if (_serverString == null)
                {
                    var methods = typeof(System.Net.Cookie).GetMethods();
